...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ei-sugimoto/tatekae/api/gen/proto_user/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "proto_user.v1.UserService"
)
...
// Login calls proto_user.v1.UserService.Login.
...
func (UnimplementedUserServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto_user.v1.UserService.Register is not implemented"))
}
